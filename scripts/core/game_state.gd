...
func new_game() -> void:
	...
	people = {
		"captain_hawke": {"id":"captain_hawke","name":"Edward Hawke","role":"captain","navigation":62,"leadership":55,"weather":58,"daily_wage":4.0,"signing_cost":40.0,"status":"available"},
		"captain_reed": {"id":"captain_reed","name":"Thomas Reed","role":"captain","navigation":74,"leadership":67,"weather":72,"daily_wage":6.0,"signing_cost":75.0,"status":"available"},
		"captain_finch": {"id":"captain_finch","name":"Samuel Finch","role":"captain","navigation":51,"leadership":70,"weather":45,"daily_wage":3.0,"signing_cost":30.0,"status":"available"}
	}
	contracts = {
